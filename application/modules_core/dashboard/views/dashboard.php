        ...
        <div class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-head pull-right">
            ...
            <ul class="dropdown-list user-list">
              <li class="new">
                <div class="thumb"><a href="#"><img src="<?php echo base_url();?>bracket/images/photos/user1.png" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Draniem Daamul (@draniem)</a> <span class="badge badge-success">new</span></h5>
                </div>
              </li>
              <li class="new">
                <div class="thumb"><a href="#"><img src="<?php echo base_url();?>bracket/images/photos/user2.png" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Zaham Sindilmaca (@zaham)</a> <span class="badge badge-success">new</span></h5>
                </div>
              </li>
              <li>
                <div class="thumb"><a href="#"><img src="<?php echo base_url();?>bracket/images/photos/user3.png" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Weno Carasbong (@wenocar)</a></h5>
                </div>
              </li>
              <li>
                <div class="thumb"><a href="#"><img src="<?php echo base_url();?>bracket/images/photos/user4.png" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Nusja Nawancali (@nusja)</a></h5>
                </div>
              </li>
              <li>
                <div class="thumb"><a href="#"><img src="<?php echo base_url();?>bracket/images/photos/user5.png" alt="" /></a></div>
                <div class="desc">
        ...
        <div class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-head pull-right">
            ...
            <ul class="dropdown-list gen-list">
              <li class="new">
                <a href="#">
                <span class="thumb"><img src="<?php echo base_url();?>bracket/images/photos/user1.png" alt="" /></span>
                <span class="desc">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="<?php echo base_url();?>bracket/images/photos/user2.png" alt="" /></span>
                <span class="desc">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="<?php echo base_url();?>bracket/images/photos/user3.png" alt="" /></span>
                <span class="desc">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="<?php echo base_url();?>bracket/images/photos/user4.png" alt="" /></span>
                <span class="desc">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="<?php echo base_url();?>bracket/images/photos/user5.png" alt="" /></span>
                <span class="desc">
      ...
      <div class="panel panel-danger panel-stat">
        <div class="panel-heading">
          ...
          <div class="stat">
            <div class="row">
              <div class="col-xs-4">
                <img src="<?php echo base_url();?>bracket/images/is-document.png" alt="" />
              </div>
              <div class="col-xs-8">
  ...
  <div class="row">
    <div class="col-sm-6 col-md-4">
      <div class="panel panel-default widget-photoday">
        <div class="panel-body">
          <a href="#" class="photoday"><img src="<?php echo base_url();?>bracket/images/photos/photo1.png" alt="" /></a>
