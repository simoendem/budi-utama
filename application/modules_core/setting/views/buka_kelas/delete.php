    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url();?>setting/buka_kelas/list_buka">Pengaturan Buka Kelas Thn Ajaran : <?php echo $tahun->tahun_ajaran?></a> </li>
          <li class="active">Batalkan Kelas</li>
        </ol>
      </div>
    </div>
    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Batalkan Kelas <?php echo $result->kelas ?>  pada : <?php echo $tahun->tahun_ajaran?> ? </h4>
          <p>Pembatalan Kelas tidak dapat dibatalkan setelah dieksekusi</p>
        </div>
        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/buka_kelas/delete_process">

        <input type="hidden" name="id_unit" value="<?php echo $result->id_unit ?>">
        <input type="hidden" name="id_buka" value="<?php echo $result->id_buka ?>">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="kelas_name" class="form-control" maxlength="100" type="text" value="<?php echo $result->kelas; ?>" disabled />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="kelas_tingkat" class="form-control" maxlength="100" type="text" value="<?php echo $result->tingkat; ?>" disabled />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
