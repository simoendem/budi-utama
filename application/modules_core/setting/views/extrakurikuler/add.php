    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Add New Extrakurikuler</li>
        </ol>
      </div>
    </div>
    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Add New Extrakurikuler on Unit <?php echo $unit->unit; ?></h4>
          <p>Add new extrakurikuler</p>
        </div>
        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/extrakurikuler/add_process">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="extra_name" class="form-control" maxlength="100" type="text" value="<?php echo $this->session->flashdata('menu_name'); ?>" required />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="extra_harga" class="form-control" maxlength="100" type="text" value="<?php echo $this->session->flashdata('menu_name'); ?>" required />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
