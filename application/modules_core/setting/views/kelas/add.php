    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Add New Kelas</li>
        </ol>
      </div>
    </div>
    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Add new Kelas on Unit <?php echo $unit->unit; ?></h4>
          <p>Add new kelas</p>
        </div>
        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/kelas/add_process">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="kelas_name" class="form-control" maxlength="100" type="text" value="<?php echo $this->session->flashdata('kelas_name'); ?>" required />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="kelas_tingkat" class="form-control" maxlength="100" type="text" value="<?php echo $this->session->flashdata('kelas_tingkat'); ?>" required />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
