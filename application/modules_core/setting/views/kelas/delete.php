    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url();?>setting/extrakurikuler/list_extra">Daftar Kelas <?php echo $unit->unit ?></a> </li>
          <li class="active">Delete Kelas</li>
        </ol>
      </div>
    </div>
    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Delete Kelas <?php echo $result->kelas ?> on Unit <?php echo $unit->unit; ?></h4>
          <p>Add new kelas</p>
        </div>
        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/kelas/delete_process">
