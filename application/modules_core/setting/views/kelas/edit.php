    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Edit Kelas on Unit <?php echo $unit->unit; ?></h4>
          <p>Edit kelas</p>
        </div>
        <form id="sasPanel" class="form-horizontal form-bordered" method="POST" action="<?php echo base_url(); ?>setting/kelas/edit_process">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="kelas_name" class="form-control" maxlength="100" type="text" value="<?php echo $result->kelas; ?>" required />
           ...
           <div class="form-group">
              ...
              <div class="col-sm-7">
                <input name="kelas_tingkat" class="form-control" maxlength="100" type="text" value="<?php echo $result->tingkat; ?>" required />
                <!-- <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
              </div>
            </div>
