    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel-body panel-body-nopadding">
              ...
              <div id="validationWizard" class="basic-wizard">
                ...
                <ul class="nav nav-pills nav-justified" id="form-regis-siswa">
                  ...
                  <li class="asal-sekolah"><a href="#vtab2" data-toggle="tab"><span>Langkah 2:</span> Info Siswa</a></li>
                  <li class="prestasi"><a href="#vtab3" data-toggle="tab"><span>Langkah 3:</span> Prestasi Siswa </a></li>
                  <li class="info-wali"><a href="#vtab4" data-toggle="tab"><span>Langkah 4:</span> Orang Tua & Wali</a></li>
                </ul>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Tahun Mulai <span class="asterisk">*</span></label>
            <div class="col-sm-3">
		...
		<div class="form-group">
		  <label class="col-sm-3 control-label">Jenjang Sekolah <span class="asterisk">*</span></label>
		  <div class="col-sm-3">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Nama Lengkap <span class="asterisk">*</span></label>
            <div class="col-sm-6">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Tempat, Tanggal Lahir <span class="asterisk">*</span></label>
            <div class="col-sm-3">
              <input type="text" name="siswa[siswa_tempat_lahir]" placeholder="Tempat lahir, contoh : yogyakarta, ..." class="form-control" required/>
            </div>
            <div class="col-sm-3">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Anak ke ... dari ...<span class="asterisk">*</span></label>
            <div class="col-sm-3">
         ...
         <div class="form-group">
            <label class="col-sm-3 control-label">Alamat tempat tinggal<span class="asterisk">*</span></label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
          ...
          <br>
            ...
            <div class="form-group">
                <h4 class="col-sm-4 text-danger">Informasi Ayah </h4>
            </div>
            <hr/>                                        
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <h4 class="col-sm-4 text-danger">Informasi Ibu </h4>
            </div>
            <hr/>                                        
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Alamat Lengkap<span class="asterisk">*</span></label>
              <div class="col-sm-6">
            ...
            <div class="form-group">
                <h4 class="col-sm-8 control-label text-danger">Informasi Wali (isikan apabila tidak tinggal bersama orang tua) </h4>
            </div>
            <hr/>                                        
