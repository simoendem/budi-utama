    <div class="pageheader">
      <h2><i class="fa fa-group"></i>Pengaturan Penempatan Kelas Thn Ajaran : <?php echo $tahun->tahun_ajaran?></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url();?>dashboard">Pinaple SAS</a></li>
          <li><a href="<?php echo base_url();?>setting/penempatan_kelas">Penempatan Kelas</a></li>
          <li class="active">Penempatan Kelas <?php echo $unit->unit ?></li>
        </ol>
      </div>
    </div>
              ...
              <tbody>
                                    <?php $no = 1; foreach ($kelass as $kelas): ?>
                                        <tr>
                                            ...
                                            <td>
                                               <a href="<?php echo base_url(); ?>setting/penempatan_kelas/penempatan/<?php echo $unit->id_unit; ?>/<?php echo $kelas->id_buka; ?>">
